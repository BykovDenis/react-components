...
const ProgressBar: React.FunctionComponent<TProgressBar> = (
  props: TProgressBar
) => {
  return (
    ...
    >
      ...
      <ProgressValueStyled
        ...
        fillColor={
          props.progress >= 51 ? props.backgroundColor : props.fillColor
        }
        backgroundColor={
          props.progress <= 49 ? props.backgroundColor : props.fillColor
        }
        direction={props.direction}
      >
        {props.progress}%
